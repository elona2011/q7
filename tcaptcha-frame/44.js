      ...
      , l = function() {
        function e(e) {
            ...
            this.createSmartVerify = function() {
                ...
                n.id = "t_verify",
                n.className = "t-verify";
                var a = r.createElement("div");
                a.className = "verify-icon",
                a.id = "verify_icon",
                n.appendChild(a);
                ...
                u.className = "verify-text",
                u.id = "verify_text",
                u.style.color = i ? "#ffffff" : "",
                n.appendChild(u);
                ...
                r.CSS(n, h),
                e.ele.appendChild(n),
                r.setPopPosition(n, o.SMART_VERIFY_SZ.width * l, o.SMART_VERIFY_SZ.height * l, e.opts.sdkOpts)
            }
            ,
            this.createFlimitDom = function() {
                ...
                o && (n.className = n.className + " dark-mode"),
                ...
                !e.isPop || e.opts.sdkOpts && e.opts.sdkOpts.width || (s.border = o ? "1px solid #999" : "1px solid #e5e5e5",
                s.borderRadius = "3px"),
                u && (s.position = "absolute"),
                r.CSS(n, s),
                e.opts.sdkOpts && e.opts.sdkOpts.width && r.setPopPosition(n, e.sizeSC.width, e.sizeSC.height, e.opts.sdkOpts);
                var c = r.createElement("div");
                c.className = "ticons ticon-refresh",
                c.id = "ticon_refresh";
                var p = r.createElement("p");
                p.className = "ticons transform-header",
                p.id = "transform_header",
                p.innerText = e.langPack.c22;
                var d = r.createElement("p");
                if (d.className = "ticons transform-text",
                d.id = "transform_text",
                d.innerText = e.langPack.c23,
                n.appendChild(c),
                n.appendChild(p),
                n.appendChild(d),
                e.isPop) {
                    var f = r.createElement("div");
                    f.id = "transform_close",
                    f.className = "ticons transform-close",
                    n.appendChild(f),
                    a.add(f, "click", function() {
                    ...
                    l.className = "ticons tback transform-eicon",
                    l.id = "transform_eicon";
                    var h = r.createElement("div");
                    h.className = "ticons tback transform-eb",
                    h.id = "transform_eb",
                    h.innerText = e.langPack.c11;
                    var m = r.createElement("p");
                    m.className = "ticons transform-eh",
                    m.id = "transform_eh",
                    e.langPack.c2.length > 20 ? (r.addClass(m, "middle-fontsize"),
                    r.addClass(h, "middle-fontsize")) : e.langPack.c2.length > 15 && (r.addClass(m, "small-fontsize"),
                    r.addClass(h, "small-fontsize")),
                    m.innerText = e.langPack.c2,
                    n.appendChild(l),
                    n.appendChild(h),
                    n.appendChild(m),
                    a.add(h, "click", function() {
                        r.removeIfExist("tcaptcha_transform"),
                        r.callbackExecutor(e, {
                            ret: 1,
                            ticket: "",
            ...
            this.createSecurityCode = function(t, o) {
                try {
                    ...
                    if (d) {
                        ...
                        l.className = "tcaptcha-container",
                        l.id = "tcaptcha_container",
                        e._div = l;
                        var h = {
                            width: e.sizeSC.width + "px",
                            height: e.sizeSC.height + "px"
                        ...
                        m.className = "tcaptcha-container-iframe",
                        ...
                        e.src = r.addUrlParam(e.src, s),
                        m.src = o || e.src,
                        this.setDivPosition(l),
                        ...
                        if (this.hasSecurityCode()) {
                            ...
                            return r.CSS(e.securityIframe, g),
                            void (e.securityIframe.src = r.addUrlParam(e.src, s))
                        }
                        var y = r.createElement("iframe");
                        y.id = "tcaptcha_iframe",
                        y.className = "tcaptcha-iframe",
                        y.setAttribute("frameborder", "0", 0),
                        y.setAttribute("border", "0"),
                        y.setAttribute("marginheight", "0", 0),
                        y.setAttribute("marginwidth", "0", 0),
                        e.isPop ? (y.setAttribute("scrolling", "no"),
                        c[t].isOpt,
                        r.CSS(y, {
                            opacity: "1"
                        })) : r.CSS(y, {
                        ...
                        if (c[t].unionSizeType ? v.position = "static" : (v.top = e.posSC.top,
                        v.left = e.posSC.left),
                        r.CSS(y, v),
                        e.securityIframe = y,
                        c[t].unionSizeType) {
                        ...
                        b.marginheight = 0,
                        b.marginwidth = 0,
                        b.setAttribute("marginheight", "0", 0),
                        b.setAttribute("marginwidth", "0", 0),
                        b.scrolling = "no",
                        b.id = "tcaptcha_iframe";
                        var w = {
                            width: "300px",
                            height: "230px",
                            border: "0px",
                        ...
                        "embed" != e.opts.type || "slidepuzzle_new" !== t && "slidepuzzle_opt" !== t ? (w.width = e.sizeSC.width + "px",
                        w.height = e.sizeSC.height + "px") : (w.width = "300px",
                        w.height = "230px"),
                        r.CSS(b, w),
                        e.securityIframe = b,
                        e.ele.appendChild(b),
