...
, function(e, t, n) {
  "use strict";
  var i, r, o = n(12), a = n(0), s = n(1), c = window.captchaConfig, u = (i = document.referrer,
  r = a.href(),
  ...
  e.exports = {
      ...
      send: function(e, t, n, i) {
          try {
              t = t && t.length > 1024 ? t.substr(0, 1024) : t;
  ...
  (i = function() {
      ...
      t = function() {
          var t, n, i, r, a, s, c = [], u = c.concat, l = c.filter, f = c.slice, d = e.document, p = {}, h = {}, m = {
              ...
              "z-index": 1,
              zoom: 1
          }, g = /^\s*<(\w+|!)[^>]*>/, v = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, y = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, w = /^(?:body|html)$/i, b = /([A-Z])/g, k = ["val", "css", "html", "text", "data", "width", "height", "offset"], x = d.createElement("table"), E = d.createElement("tr"), T = {
              ...
              th: E,
              "*": d.createElement("div")
          }, S = /^[\w-]*$/, z = {}, C = z.toString, j = {}, P = d.createElement("div"), R = {
              tabindex: "tabIndex",
              readonly: "readOnly",
              "for": "htmlFor",
              "class": "className",
          ...
          ;
          function O(e) {
              return null == e ? String(e) : z[C.call(e)] || "object"
          }
          function A(e) {
              return "function" == O(e)
          }
          ...
          function L(e) {
              return D(e) && !I(e) && Object.getPrototypeOf(e) == Object.prototype
          }
          function F(e) {
          ...
          return j.matches = function(e, t) {
              ...
              return o && (r = P).appendChild(e),
              i = ~j.qsa(r, t).indexOf(e),
              o && P.removeChild(e),
              i
          }
          ,
          ...
          j.init = function(e, n) {
              ...
              if ("string" == typeof e)
                  ...
                  if (_(e))
                      ...
                      r = j.fragment(e.trim(), RegExp.$1, n),
                      e = null;
                  else {
                      if (n !== t)
                          return i(n).find(e);
          ...
          i.fn = {
              ...
              concat: function() {
                  ...
                  for (e = 0; e < arguments.length; e++)
                      t = arguments[e],
                      n[e] = j.isZ(t) ? t.toArray() : t;
                  return u.apply(j.isZ(this) ? this.toArray() : this, n)
              },
              map: function(e) {
              ...
              is: function(e) {
                  return "string" == typeof e ? this.length > 0 && j.matches(this[0], e) : e && this.selector == e.selector
              },
              not: function(e) {
                  var n = [];
                  if (A(e) && e.call !== t)
              ...
              closest: function(e, t) {
                  ...
                  return this.each(function(i, o) {
                      for (; o && !(r ? r.indexOf(o) >= 0 : j.matches(o, e)); )
                          o = o !== t && !M(o) && o.parentNode;
              ...
              parent: function(e) {
                  return W(s(this.pluck("parentNode")), e)
              },
              children: function(e) {
              ...
              siblings: function(e) {
                  return W(this.map(function(e, t) {
              ...
              html: function(e) {
                  return 0 in arguments ? this.each(function(t) {
                      ...
                      i(this).empty().append(Y(this, e, t, n))
                  ...
                  return "string" != typeof e || 1 in arguments ? this.each(function(t) {
                      if (1 === this.nodeType)
                          if (D(e))
                              ...
                              H(this, e, Y(this, i, t, this.getAttribute(e)))
              ...
              prop: function(e, t) {
                  return "string" != typeof (e = R[e] || e) || 1 in arguments ? this.each(function(i) {
                      if (D(e))
                          for (n in e)
                              this[R[n] || n] = e[n];
                      else
                          this[e] = Y(this, t, i, this[e])
                  }) : this[0] && this[0][e]
              },
                  ...
                  return this.each(function(n) {
                      if ("className"in this) {
                          if (e === t)
                              return G(this, "");
                          r = G(this),
                          Y(this, e, n, r).split(/\s+/g).forEach(function(e) {
                              r = r.replace(V(e), " ")
                          }),
                          G(this, r.trim())
                      }
          ...
          ["width", "height"].forEach(function(e) {
              ...
              i.fn[e] = function(r) {
                  var o, a = this[0];
                  return r === t ? I(a) ? a["inner" + n] : M(a) ? a.documentElement["scroll" + n] : (o = this.offset()) && o[e] : this.each(function(t) {
                      (a = i(this)).css(e, Y(this, r, t, a[e]()))
                  })
              }
          }),
              ...
              i.fn[n] = function() {
                  var n, a, s = i.map(arguments, function(e) {
                      ...
                      return "array" == (n = O(e)) ? (e.forEach(function(e) {
                          return e.nodeType !== t ? r.push(e) : i.zepto.isZ(e) ? r = r.concat(e.get()) : void (r = r.concat(j.fragment(e)))
                      }),
                      r) : "object" == n || null == e ? e : j.fragment(e)
                  }), c = this.length > 1;
          ...
          j.Z.prototype = q.prototype = i.fn,
          j.uniq = s,
          j.deserializeValue = U,
          i.zepto = j,
          i
      }(),
      e.Zepto = t,
      ...
      function(t) {
          ...
          t.ajax = function(r) {
              ...
              "jsonp" == x)
                  ...
                  t.ajaxJSONP(b, k);
              var T, S = b.accepts[x], z = {}, C = function(e, t) {
                  z[e.toLowerCase()] = [e, t]
              }, j = /^([\w-]+:)\/\//.test(b.url) ? RegExp.$1 : e.location.protocol, P = b.xhr(), R = P.setRequestHeader;
              if (k && k.promise(P),
              b.crossDomain || C("X-Requested-With", "XMLHttpRequest"),
              C("Accept", S || "*/*"),
              (S = b.mimeType || S) && (S.indexOf(",") > -1 && (S = S.split(",", 2)[0]),
              P.overrideMimeType && P.overrideMimeType(S)),
              (b.contentType || !1 !== b.contentType && b.data && "GET" != b.type.toUpperCase()) && C("Content-Type", b.contentType || "application/x-www-form-urlencoded"),
              b.headers)
                  for (i in b.headers)
                      C(i, b.headers[i]);
              if (P.setRequestHeader = C,
              P.onreadystatechange = function() {
                  if (4 == P.readyState) {
                      P.onreadystatechange = y,
                      clearTimeout(T);
                      var e, n = !1;
                      if (P.status >= 200 && P.status < 300 || 304 == P.status || 0 == P.status && "file:" == j) {
                          if (x = x || ((i = b.mimeType || P.getResponseHeader("content-type")) && (i = i.split(";", 2)[0]),
                          ...
                          "arraybuffer" == P.responseType || "blob" == P.responseType)
                              ...
                              try {
                                  ...
                                  "script" == x ? (0,
                                  eval)(e) : "xml" == x ? e = P.responseXML : "json" == x && (e = f.test(e) ? null : t.parseJSON(e))
                              } catch (r) {
                                  n = r
                              }
                              if (n)
                                  return g(n, "parsererror", P, b, k)
                          }
                          m(e, P, b, k)
                      } else
                          g(P.statusText || null, P.status ? "error" : "abort", P, b, k)
                  }
                  var i
              }
              ,
              !1 === h(P, b))
                  ...
                  g(null, "abort", P, b, k),
                  P;
              var _ = !("async"in b) || b.async;
              if (P.open(b.type, b.url, _, b.username, b.password),
              b.xhrFields)
...
, function(e, t, n) {
  ...
  e.exports = function(e, t, n, l) {
          ...
          for (var e = function(e) {
              ...
              t.parents().each(function(r, o) {
                  ...
                  if (a.test(s.css("position"))) {
                      ...
                      b.min = c[z],
                      b.max = c[i] + c[z] - n[i],
                      t.css(z, b.left + "px")) : (E[e] = b.middle - n[i] / 2,
                      t.css(z, b.middle - n[i] / 2 + "px")),
                      !1
                  }
              })
          }, t = 0; t < T.length; t++)
      ...
      (_ = $(e)).on("mousedown touchstart", R),
      _.on("mousemove touchmove", A),
      _.on("mouseup touchend touchcancel", I),
      $(document).on("mousemove", A),
      $(document).on("mouseup mouseleave", I),
      _.on("touchstart", function(e) {
          if ($(e.target).parents().index(_) >= 0 && "coverReload" != e.target.id)
              return !1
      }),
      i.listen(1, C),
      function() {
...
, function(e, t, n) {
  "use strict";
  var i, r, o = n(11), a = window.document.documentElement, s = window.document.documentElement.style.fontSize, c = (r = "fontSize",
